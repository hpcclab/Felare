...
for i in range(len(task_types)):
    ...
    if tt=='TT1':
        ...
        l = 'speech recog'
    ax1.bar(r, results[tt].values, label = l, color='none',zorder=0,
...
plt.savefig(f'../../output/figures/revised_with_more_arrivals/fairness-phases-{workload}-more-heuristics-real.pdf',dpi=300)
plt.show()      
