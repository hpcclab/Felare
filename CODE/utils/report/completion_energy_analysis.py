...
rate_label = [round(2000/x,1) for x in [800, 667, 500, 400, 333, 250, 200, 100]]
...
#plt.grid(axis='y')
plt.tight_layout()
plt.savefig(f'../../output/figures/revised_with_more_arrivals/{objective}-lineplot-more-heuristics-real.pdf',dpi=300)
