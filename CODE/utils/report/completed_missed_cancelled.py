...
rate_label = [round(1000/x,2) for x in [1000, 800,  667, 500, 400, 333, 250, 200, 100]]
...
#plt.grid(axis='y')
plt.tight_layout()
plt.savefig(f'../../output/figures/revised_with_more_arrivals/missed_cancelled_revised_real.pdf',dpi=300)
